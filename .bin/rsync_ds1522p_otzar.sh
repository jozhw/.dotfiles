...
if [ "$input" -eq 0 ]; then
    ...
    rsync -anPv --no-times --exclude='**/.DS_Store' --delete Core/Otzar jozhw@ds1522p.wu.ventures:/volume2/johnz.wu
    rsync -anPv --no-times --no-perms --no-owner --no-group --exclude='**/.DS_Store' --delete Downloads/books jozhw@ds1522p.wu.ventures:/volume2/johnz.wu/Downloads
    ...
    rsync -aPv --no-times --append-verify --exclude='**/.DS_Store' --delete Core/Otzar jozhw@ds1522p.wu.ventures:/volume2/johnz.wu   
    rsync -aPv --no-times --no-perms --no-owner --no-group --append-verify --exclude='**/.DS_Store' --delete Downloads/books jozhw@ds1522p.wu.ventures:/volume2/johnz.wu/Downloads

    # rsync -aPv --append-verify --exclude='**/.DS_Store' Core/wu/* jozhw@ds1522p.wu.ventures:/volume1/wu
