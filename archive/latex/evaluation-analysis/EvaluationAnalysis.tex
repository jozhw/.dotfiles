...
% link to Openleaf = https://www.overleaf.com/latex/templates/luxsleek-cv/qbvbqmrzxwyj
%
...
\definecolor{palette}{HTML}{eeeee4}  % Define palette color
...
\colorbox{palette!90}{\color{black}  %% LEFT BOX
\kern0.09\textwidth\relax% Left margin provided explicitly
\begin{minipage}[t][293mm][t]{0.82\textwidth}
\raggedright
\vspace*{2.5ex}

% previous was this below
% \Large Guillaume \textbf{\textsc{Ouancaux}} \normalsize 
\Large Random Person Name \normalsize

% change the code below to change the picture by giving the relative path
% Centering without extra vertical spacing
\null\hfill\includegraphics[width=0.65\textwidth]{assets/glow-texture.png}\hfill\null
...
\headleft{Notable Traits \& Abilities}
...
\headright{\Large ANALYSIS  -- MONTH XX, XXXX}
...
\headright{Strengths and Weaknesses}
...
\headright{Protocol of Interaction}
