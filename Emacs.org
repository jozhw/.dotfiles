...
*** The =init.el= essential key configuration for smooth scrolling 
...
A link to the github issue where I found the solution is [[https://github.com/minad/vertico/discussions/501#discussioncomment-12390155][here]].
...
*** The =jw-emacs-langs.el= section for =latex=
