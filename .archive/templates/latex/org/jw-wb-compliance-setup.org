...
% Keep section numbering for outline, but hide it in the document
#+LATEX_HEADER_EXTRA: \setcounter{tocdepth}{3}
#+LATEX_HEADER_EXTRA: \setcounter{secnumdepth}{3}
#+LATEX_HEADER_EXTRA: \usepackage{titlesec}

% Modify section numbering format to include the word "Section"
#+LATEX_HEADER_EXTRA: \titleformat{\section}[block]{\normalfont\Large\bfseries}{Section \thesection.}{1em}{}
#+LATEX_HEADER_EXTRA: \titleformat{\subsection}[block]{\normalfont\large\bfseries}{Section \thesubsection.}{1em}{}
#+LATEX_HEADER_EXTRA: \titleformat{\subsubsection}[block]{\normalfont\normalsize\bfseries}{Section \thesubsubsection.}{1em}{}
