...
keymap.set(
    "n",
    "<localleader>tje",
    "<cmd>read ~/templates/latex/journal-entry/JournalEntry.tex<CR>"
)

keymap.set(
    "n",
    "<localleader>tmn",
    "<cmd>read ~/templates/latex/message-notes/MessageNotes.tex<CR>"
)

keymap.set(
    "n",
    "<localleader>tba",
    "<cmd>read ~/templates/latex/book-analysis/BookAnalysis.tex<CR>"
)
